...
- 互动评论（列表）：每部影片须输出 2--4 条；每条 18--60 字。
  1) 第一条（必须）：与影片直接相关的疑问句（问号结尾，12--40 字），采用第一人称或无主语中性表述，聚焦“一件具体事”（镜头/动机/台词/象征），带轻微不确定或情绪色彩（如：我有点没懂/有点懵/一直在想）。
  ...
  2) 第二条（必须）：第一人称观众视角“托”（热心推荐，点一处具体感受或小细节），不过度煽动，不夹带 CTA。
...
if __name__ == '__main__':
    ...
    username_list = ['nana', 'taoxiao', 'danzhu', 'hong', 'jie', 'cai', 'xiaosu', 'jun', 'dan', 'ning', 'yiyi', 'qiqixiao', 'xiaoxue', 'xiu']
    while True:
        start_time = time.time()
