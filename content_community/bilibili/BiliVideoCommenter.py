...
interactive_comment_list = [
    "已点赞、已评论、已发弹幕并关注了。很期待你有空回访我的视频并关注我，谢谢！",
    "我看完了，点赞+弹幕+评论+关注都做了。若方便请回头看看我的作品并关注我～",
    "支持你，已赞、已评、已弹幕并已关注。希望你也能看一下我的视频并关注我。",
    "已从头看完并点赞评论发弹幕，还顺手关注了。诚挚邀请你回访并关注我。",
    "已完成三连并关注，感谢你的内容。若有空请来我这儿看看并关注一波。",
    "给你点了赞、发了弹幕、留了评论并关注了。期待你的回访和关注，感谢～",
    "全程观看并支持：点赞、弹幕、评论、关注都已完成。请回访我的视频并关注我吧。",
    "已赞评弹并关注，真心喜欢这期内容。希望你也能抽空看一下我的作品并关注。",
    "已点赞并发弹幕、写评论、关注你。若方便欢迎互相关注、互相支持。",
    "支持UP主：赞、评、弹幕、关注都到位。期待你的回访和关注，非常感谢！",
    "我刚完成‘看完→点赞→弹幕→关注’四连环，你也来完成你的那一半好吗？",
    "弹幕已留、点赞已点、评论已写、关注也搞定。来互粉互撩一下呗～",
    "我把你的弹幕当作早餐吃了：已赞、已评、已弹幕、已关注。求回访喂我回弹幕！",
    "全程潜伏并完成三连+关注，等你来我视频也上演一出‘回访大戏’！",
    "已给你点了赞、发了弹幕并关注，换个方式说：你来我这儿露个面呗？",
    "看完立刻三连+关注，友情提醒：回访会获得独家弹幕回复～",
    "我已经把你的头像印在我关注列表里：赞、评、弹、关注全到位，等你来回访！",
    "我的弹幕已占座，点赞已上保险，评论已就绪，关注也到位 —— 现在轮到你登场！",
    "已完成四步式支持（看完/赞/评/弹/关注），欢迎带队来我视频集合！",
    "给你送上三连和关注，回访并关注我吧，我们互为VIP粉丝！",
]
