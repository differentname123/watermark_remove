...
csrf_token = get_config("ning_bilibili_csrf_token")
...
interactive_comment_list = [
    # 类别一：直接热情型
    "UP主太强了！视频已经完整看完，赞和弹幕也都安排上了。期待有空也能来我的视频里发条弹幕，一起把数据搞上去！",
    "全程跟完，质量超高！赞和弹幕已奉上。我的新视频也需要弹幕护体，等你来呀！",
    "这期太顶了，全程高能！点赞和弹幕是对好作品最基本的尊重！我也刚发了新作品，期待能看到你的弹幕出现在我的视频里！",
    "已赞，已发弹幕，已全程观看。任务完成！等你回访，期待你的弹幕大军！",
    "看完啦！很有趣的内容，弹幕和赞都点了。希望我的视频也能被你完整看完，弹幕gogogo！",

    # 类别二：惺惺相惜型
    "全程看完，内容做得真好！赞和弹幕都已支持。大家做视频都不容易，欢迎回访交流，期待你的弹幕！",
    "从头看到尾，必须点赞支持！弹幕也刷起来了。同为UP主，深知播放时长和弹幕的重要，有空常来我这儿坐坐！",
    "UP主你好，你的视频我全程看完了，学到很多，也点了赞发了弹幕。如果能抽空来看看我的视频并留下一条弹幕，我会非常开心的！",
    "很棒的视频，完整看完了！点赞和弹幕是我的态度。希望能和你相互支持，一起进步，有空来看看我的视频，弹幕刷起来！",
    "很用心的作品，全程看完，弹幕和赞已就位。希望这份支持可以相互传递，等你来我的视频里发弹幕哦！",

    # 类别三：幽默调侃型
    "UP主更新辛苦！已执行“看完-点赞-发弹幕”三步走战略。我的视频也急需弹幕支援，呼叫UP主！",
    "好家伙，不知不觉就看完了！弹幕里已经留下我的DNA，赞也点了。我的视频时长和你差不多，要不要也来挑战一下全程看完？",
    "弹幕已发送，赞已点亮，视频已看完！UP主，我的“礼”到了，你的呢？等你来我视频里互动呀！",
    "报告UP主！我已成功潜入你的视频并从头看到了尾，还留下了弹幕和点赞作为标记。等待你的反向“侦察”！",
    "一条龙服务：看完+点赞+弹幕！UP主的内容值得。我的主页也欢迎大佬莅临指导，期待你的弹幕点评！",

    # 类别四：偶尔带上“硬币”的经典款
    "太精彩了！全程看完，赞和弹幕都送上了。硬币今天告急，下次一定补上！有空也欢迎来我这儿串个门，全程看完就是最大的支持啦！",
    "这视频值得一个三连，可惜我的币今天用完了。但我还是坚持看完了全程，发了弹幕和评论！期待你也能来我的视频里玩，发个弹幕就更好啦！",
    "从头到尾一秒不落，弹幕和赞都点了！今天币的额度用完了，下次一定投！希望大家都能相互支持，一起把视频做火！等你来哦！",
    "视频质量真高，完整看完并发送了弹幕和赞。硬币先记在账上哈，下次一定投！希望能沾沾你的欧气，有空也来看看我的视频吧！",
    "完美的作品！我已经从头到尾认真学习了一遍，弹幕和赞也已奉上。囊中羞涩，硬币不足，下次补给。但更期待的是你能来我视频里发条弹幕交流一下！"
]
