...
7.  **点击增长策略：钩子铁三角 (Hook Trinity Strategy)**
      ...
      * **A/B测试思维**：在后续生成标题时，必须从至少两个不同的心理角度出发设计候选标题。例如：一个利用“好奇心缺口/颠覆常识”，另一个利用“身份认同/焦虑”。
        标题心理学角度库 (Title Psychology Angles Library):
            好奇心缺口: 制造悬念，引发“为什么”的疑问。
            身份认同/焦虑: 精准召唤特定人群，或击中其痛点。
            颠覆常识: 挑战观众的固有认知，制造冲击感。
            强烈对比: 通过戏剧性的反差，突出核心亮点。
            价值/结果承诺: 明确告知观众看完视频能获得什么具体好处。
            负面警示: 以“千万别”、“……的代价”等形式，利用规避损失的心理。
            情感共鸣: 直接抒发一种强烈的情绪，吸引同频的人。
...
9.  **叙事技巧与节奏规划 (Narrative Techniques & Pacing Plan)**：
      ...
      * **叙事与增长技巧库 (Narrative & Growth Techniques)**
          ...
          * **分类C: 互动与共鸣 (用于提升互动率与分享率)**
              ...
              * `C3: “递进式提问”`: 在视频中段，连续向观众抛出2-3个由浅入深、层层递进的问题，引导他们跟随你的思路进行深度思考，并在评论区写下“思想钢印”般的回答。
              
              *--- 结尾双轨策略 ---*

              *# [轨道一：高级互动 (首选)]*
              *`C4: “洞见延伸”式互动 (Insight-Extension Interaction)`*: 这是最高级的互动形式，也是结尾的首选。它的核心不是提问，而是将视频的“核心洞见”延伸成一个能引发观众进行“二次创作”或“深刻自我审视”的挑战。一个真正好的“洞见延伸”式互动，其答案本身就是一个微型故事或一个鲜明的态度。
                  * **质量自检铁律 (CRITICAL SELF-CHECK RULE):** 在设计此互动时，必须在内心回答：“这个问题是为这个视频‘量身定做’的，还是一个可以套用在很多视频里的‘万能模板’？” **如果感觉像模板，则绝对禁止使用，必须启动轨道二。**
                  * **模板化提问 (应被禁止):** “你怎么看？”、“你经历过什么？”、“如果换成你，你会怎么选？”
                  * **高质量示范 (社会事件类):** (视频核心洞见：群体在网络事件中容易被情绪裹挟。) -> **结尾互动:** “所以，当下一个热点来临时，我们都面临一个选择：是成为第一批发声的人，还是成为那个愿意‘让子弹再飞一会儿’的少数派？把你的选择，用一个词留在评论区。”
                  * **高质量示范 (个人成长类):** (视频核心洞见：完美主义是行动的最大敌人。) -> **结尾互动:** “今天，就当给自己放个假。在评论区立个flag，写下一件你早就想做、但因为怕做不好而迟迟没开始的小事。不需要完美，只需要‘开始’这两个字的力量。”

              *# [轨道二：纯粹余韵 (备选/安全网)]*
              *`C5: “共鸣余音”式收尾 (Resonant Echo Ending)`*: 这是当无法构思出高质量的`C4`互动时，**必须采用**的备选方案。它完全放弃直接互动，转而将视频的核心情感或观点，凝练成一句强有力、有画面感、值得回味的陈述句，作为送给观众的“精神赠品”。它的目标是“意犹未尽”，而非“索要评论”。
                  * **执行要点:** 绝对不使用问号。文案要像诗歌的最后一句，或电影的最后一个镜头，在沉默中给予观众最大的力量。
                  * **示范 (对应C4的社会事件类):** “或许在信息爆炸的时代，最稀缺的能力，不是表达，而是在喧嚣中，捍卫自己内心那几秒钟的沉默与思考。”
                  * **示范 (对应C4的个人成长类):** “真正让我们成长的，从来不是那一次完美的成功，而是那个虽然笨拙、但终于敢于开始的下午。”

      * **节奏蓝图 (Pacing Plan)**: 基于三幕式结构，简要说明你计划如何分配节奏和技巧。例如：“第一幕 (15%) 用‘颠覆常识’强力钩子；第二幕 (60%) 依次展开2个分论点，中间穿插`B6:中段再挂钩`；第三幕 (25%) 升华主题，并采用‘双轨制结尾策略’选择`C4`或`C5`收尾，最终以金句呼应，促成转发。”
...
3.  **“原则符合度”拷问：**
      ...
      * **检查清单：**
          ...
          * `d. 结尾策略是否通过“质量门”审核？`：我是否严格遵循了“双轨制结尾策略”？
             * **第一重检查：** 我是否已优先尝试构思一个高质量的 `C4: “洞见延伸”式互动`？
             * **第二重检查：** 这个构思出的`C4`互动，是否100%通过了其自带的“质量自检铁律”，即它听起来是完全为本视频“量身定做”的，而非一个廉价的“万能模板”？
             * **最终决策：** * 如果第二重检查答案为【是】，我是否已在文案结尾使用了这个高质量互动？
                 * 如果第二重检查答案为【否】（即我想不出足够好的互动，或它听起来很模板化），我是否已**果断放弃互动**，并转而使用了 `C5: “共鸣余音”式收尾`，来保证视频的最终格调和余韵？
             * **底线规则：** 我是否确保最终的文案中，**绝对没有出现**任何平庸的、模板化的、或乞讨式的互动结尾？
...
```json
{
  "策略阐述": {
    ...
    "叙事技巧与节奏规划": "（技巧组合：A2:颠覆常识, B4:场景化故事举例, [C4或C5结尾二选一]。节奏蓝图：第一幕(15%)-用A2破题；第二幕(60%)-用B4展开2个分论点；第三幕(25%)-采用“双轨制结尾策略”收尾并以金句时刻升华。）"
  },
  "执行方案": {
    "目标观众": "（描述核心受众）",
    "标题": [
...
if __name__ == "__main__":
    question_id = "1932093973054358515"
    output_file = f"{question_id}/zhihu_answers_{question_id}.json"
    real_final_result = read_json(output_file)
    video_output_file = output_file.replace(".json", "_video_info.json")
    # video_info = gen_zhihu_video_by_answer(real_final_result, video_output_file)
