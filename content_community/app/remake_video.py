...
def gen_cut_suggestion(video_path):
    ...
    try:
        ...
        prompt = """# 角色
                    ...
                    5.  如果该场景中有不相关的内容（如广告 推广 甚至是关于我的声明或者介绍）不管是不是我推荐的，那么这个场景都应该被删除,立即识别并删除任何包含我的个人身份信息（如Logo、个人头像、姓名、联系方式等）的场景。这是强制性要求。
                    6. 而且要尽量不要产生太多的剪切点，因为会导致难度大大提示,我非常反感为了改而改的微小调整。如果原始顺序已经足够好，或者任何改动带来的提升都微不足道，请明确指出应保留原顺序，并解释原因。减少不必要的剪辑工作量是一个重要的考量点。
